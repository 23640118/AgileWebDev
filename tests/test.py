...
def write_db():
    ...
    user2 = User(username = 'test', email = 'test@t.com', password = generate_password_hash('asd'), money = 100)
...
class BasicTest(unittest.TestCase):
    ...
    def test_password_hashing(self):
        u = User.query.get(1)
        self.assertFalse(u.check_password('not_the_password'))
        self.assertTrue(u.check_password('asd'))
